                        ...
                        <div class="d-sm-flex justify-content-between mt-lg-4 mb-4 pb-3 pb-sm-2 border-bottom">
                            <div class="d-block d-sm-flex align-items-start text-center text-sm-start">
                                ...
                                <a class="d-block flex-shrink-0 mx-auto me-sm-4" href="shop-single-v1.html" style="width: 10rem;">
                                    <img src="{{ asset('storage/' . $cat->category_img) }}" alt="Category Image">
                                </a>
                                <div class="pt-2">
                                    <h3 class="product-title fs-base mb-2">{{ $cat->category_name }}</h3>
                                    <div class="fs-sm">
                                        <span class="text-muted me-2">Description:</span>{{ $cat->category_description }}
                                    </div>
                                </div>
                            </div>
                        ...
                        <nav class="d-flex justify-content-between pt-2 mb-4" aria-label="Page navigation">
                            <ul class="pagination">
                                <li class="page-item {{ $category->onFirstPage() ? 'disabled' : '' }}">
                                    <a class="page-link" href="{{ $category->previousPageUrl() }}"><i class="ci-arrow-left me-2"></i>Prev</a>
                                </li>
                            </ul>
                            <ul class="pagination">
                            ...
                            <ul class="pagination">
                                <li class="page-item {{ $category->hasMorePages() ? '' : 'disabled' }}">
                                    <a class="page-link" href="{{ $category->nextPageUrl() }}">Next<i class="ci-arrow-right ms-2"></i></a>
                                </li>
                            </ul>
                        </nav>
                    </section>
